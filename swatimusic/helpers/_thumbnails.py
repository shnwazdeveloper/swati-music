...
from swatimusic import config
from swatimusic.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("swatimusic/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("swatimusic/helpers/Inter-Light.ttf", 30)
